package keyboardLayouts
{
	...
	public class EmailAlt extends KeyboardLayoutData
	{
		public static const ID:String = "emailAlt";

		public function EmailAlt(backspaceIcon:Texture = null, backspaceDownIcon:Texture = null,
				...
				closeKeyboardIcon:Texture = null, closeKeyboardDownIcon:Texture = null)
		{
			super(ID, new <RowData>[
						...
						new RowData(new <IRenderableData>[
								...
								KeyData.createCharacterKey(",".charCodeAt()),
								KeyData.createCharacterKey(".".charCodeAt()),
								KeyData.createToggleKey(null, Keyboard.SHIFT, 1.45, false, shiftIcon, shiftDownIcon, shiftSelectedIcon)
							]),
						new RowData(new <IRenderableData>[
								KeyData.createSwitchLayoutKey("ABC", Email.ID, 1.75),
								new GapData,
